...
*/
let arraySpostamento = [];
arraySpostamento = pets.shift();
pets.push(arraySpostamento);
...
for (let i = 0; i < cars.length; i++) {
  cars[i].licensePlate = "EF75" + Math.floor(Math.random() * 10) + "HC";
}
...
let newCar = {
  ...
  model: "911",
  color: "Yellow",
  trims: ["bella", "bellissima", "top"],
  licensePlate: "EF759HC",
};
cars.push(newCar);
for (let i = 0; i < cars.length; i++) {
  cars[i].trims.pop();
